...
function getUnlockedProducers(data) {
 ...
 const theUnlocked = data.producers.filter(unlocked === true);
 return theUnlocked;
 //TEACHER CHECK - another possible answer:(is this legit?) return.data.producers.filter(producer => producer.unlocked === true)
}
...
bigCoffee.addEventListener(clickCoffee, data);
...
elementReferencedAtTheTopOfThisFile.addEventListener(buyButtonClick, data);
